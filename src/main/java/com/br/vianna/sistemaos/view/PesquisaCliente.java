...
public class PesquisaCliente extends javax.swing.JDialog {
    ...
    private void jbPesquisaCpfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisaCpfActionPerformed
        ...
        try {
            ...
            String[] linha = {cliente.getNome(), cliente.getCpf(), cliente.getFuncionario().getNome()};
            dftm.addRow(linha);
    ...
    private void jbPesquisaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisaNomeActionPerformed
        ...
        try {
            ...
            clientes = new ClienteDAO().buscarPorNome(jtPesquisaNome.getText());
            ...
            if (!senha.equals("123")) {
                ...
                if (JOptionPane.showConfirmDialog(null, "Deseja apagar o cliente " + clientes.get(row).getNome() + "?",
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Erro ao tentar apagar o cliente!");
                    }
    ...
    private void prencherTabela(ArrayList<Cliente> clientes) {

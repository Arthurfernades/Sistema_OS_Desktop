 ...
 * @author arthu
 */
public class SistemaOSCadastroUsuario extends javax.swing.JDialog {

    /**
     * Creates new form SistemaOSCadastro
     */
    public SistemaOSCadastroUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
                ...
                if (jcbTipo.getSelectedItem().toString().equals("Administrador")) {
                    ...
                    if (!senha.equals("123")) {
                        ...
                        if (usuario == null) {
                            ...
                            usuario = new Administrador(null, 0, jtNome.getText(),
                                    jtLoginCadastro.getText(), jpSenhaCadastro.getText(),
                                    jtEmail.getText(), ETipoUser.A, null, null);
                            ...
                            usuario.setLogin(jtLoginCadastro.getText());
                            usuario.setNome(jtNome.getText());
                            usuario.setSenha(jpSenhaCadastro.getText());
                            usuario.setTipo(ETipoUser.A);
                    ...
                    if (usuario == null) {
                        ...
                        usuario = new Administrador(null, 0, jtNome.getText(),
                                jtLoginCadastro.getText(), jpSenhaCadastro.getText(),
                                jtEmail.getText(), ETipoUser.F, null, null);
    ...
    private void jtLoginCadastroFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtLoginCadastroFocusLost
        ...
        try {
            ...
            Usuario u = new UsuarioDAO().buscarPorLogin(jtLoginCadastro.getText());
    ...
    private void jtEmailFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtEmailFocusLost
        ...
        try {
            ...
            Usuario u = new UsuarioDAO().buscarPorEmail(jtEmail.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaOSCadastroUsuario.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SistemaOSCadastroUsuario dialog = new SistemaOSCadastroUsuario(new javax.swing.JFrame(), true);
    ...
    void preparedEdit(Usuario usuario) {
        ...
        jcbTipo.setSelectedItem(usuario.getTipo());

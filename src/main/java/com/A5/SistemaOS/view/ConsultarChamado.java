 ...
 * @author arthu
 */
public class ConsultarChamado extends javax.swing.JDialog {

    /**
     * Creates new form ConsultarChamado
     */
    public ConsultarChamado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarChamado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarChamado dialog = new ConsultarChamado(new javax.swing.JFrame(), true);

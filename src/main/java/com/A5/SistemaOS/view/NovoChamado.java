 ...
 * @author arthu
 */
public class NovoChamado extends javax.swing.JDialog {
    ...
    public NovoChamado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        os.setId(0);
            ...
            this.funcionarios = fDao.findAll();
            this.clientes = cDao.findAll();
    ...
    private void jbCriarChamadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCriarChamadoActionPerformed
            ...
            Funcionario f = fDao.findByLogin(jcbFuncionario.getSelectedItem().toString());

            Cliente c = cDao.findByCpf(jcbCliente.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(NovoChamado.class.getName()).log(Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NovoChamado dialog = new NovoChamado(new javax.swing.JFrame(), true);

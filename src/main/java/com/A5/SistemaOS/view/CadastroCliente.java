...
public class CadastroCliente extends javax.swing.JDialog {
                ...
                if (!dataString.equalsIgnoreCase("")) {
                    ...
                    if (cliente == null) {
                        ...
                        if (jcbSexo.getSelectedItem().toString().equals("Masculino"))
                            cliente.setSexo(ETipoSexo.MASCULINO);
                        else
                            cliente.setSexo(ETipoSexo.FEMININO);

                        cliente.setNome(jtNome.getText());
                        cliente.setCpf(jtCpf.getText());
                        cliente.setNasc(localDate);
    ...
    private void jtCpfFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtCpfFocusLost
        ...
        Cliente cliente;
            ...
            cliente = cDao.findByCpf(jtCpf.getText());
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        funcionarios = fDao.findAll();
            ...
            for (Funcionario funcionario : funcionarios) {
                ...
                jcbFuncionario.addItem(funcionario.getLogin());
